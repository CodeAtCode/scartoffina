...
## 4. Valori di Riferimento — Anno 2025 (dichiarazione 2026)
...
La skill include script Python per calcoli deterministici. Eseguire da `skills/fiscalista/scripts/`:

| Script | Descrizione | Esempio uso |
|--------|-------------|-------------|
| `calc_irpef.py` | Calcolo IRPEF completo con scaglioni, detrazioni, addizionali | `python3 calc_irpef.py --reddito 45000 --figli 2 --regione lombardia` |
| `calc_imu.py` | Calcolo IMU su immobili | `python3 calc_imu.py --rendita 500 --categoria A2 --aliquota 0.76` |
| `calc_cedolare_secca.py` | Calcolo cedolare secca su locazioni | `python3 calc_cedolare_secca.py --canone 12000 --aliquota 21` |
| `calc_capital_gain.py` | Calcolo capital gains (crypto, azioni) | `python3 calc_capital_gain.py --acquisto 10000 --vendita 15000 --tipo crypto` |
| `update_data.py` | Controllo freschezza dati e aggiornamenti | `python3 update_data.py --check` |

### 5.1 calc_irpef.py — Calcolo IRPEF completo
...
## 6. Promemoria Obbligatori per Argomento
...
### 7.1.1 Esempio completo: calcolo IRPEF
...
### 7.2 Addizionali regionali e comunali
...
### 7.2.1 Esempio: addizionali (Lazio, Roma)
...
### 7.4 Tassazione rendite finanziarie
...
### 7.4.1 Esempio: tassazione rendite
...
### 7.5 Crypto-attività (Quadro RW e RT)
...
### 7.6.1 Esempio: regime forfettario
